    ...
    <div className="bg-white dark:bg-gray-dark p-8 rounded-2xl border border-gray-100 dark:border-dark-3 shadow-sm">
      ...
      {step === 1 ? (
        ...
        <div className="flex flex-col lg:flex-row gap-12 mt-8">
          ...
          <div className="flex-1">
            <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-6">Admins</h3>
            <div className="space-y-4 mb-6">
              {admins.map((admin, idx) => (
                <div key={idx} className="flex items-center gap-4 p-4 border border-gray-100 dark:border-dark-3 rounded-lg bg-gray-50 dark:bg-dark-2">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-gray-500 dark:text-dark-6">{admin.email}</div>
                  </div>
                </div>
              ))}
              {admins.length === 0 && <p className="text-sm text-gray-500">No admins added yet.</p>}
            </div>
          </div>
