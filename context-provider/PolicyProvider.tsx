  ...
  const createPolicyAction = async (
    ...
    try {
      ...
      const payload: PolicyRequestCreate = {
        ...
        net_premium: formData.get("net_premium") ? Number(formData.get("net_premium")) : null,
        gst_amount: formData.get("gst_amount") ? Number(formData.get("gst_amount")) : null,
        total_premium: formData.get("total_premium") ? Number(formData.get("total_premium")) : null,
